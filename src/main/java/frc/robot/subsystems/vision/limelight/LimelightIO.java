...
public class LimelightIO implements VisionIO {
    ...
    public LimelightIO(String theName,  boolean forPoseEstimation, Supplier<Rotation2d> rotationSupplier, Supplier<Double> angularVelocitySupplier, boolean useMegaTag2)
    {
        name = theName;
    ...
    public Optional<VisionEstimate> getVisionEst() {
        ...
        */
        ...
        if (alliance.isPresent()) {
            ...
            LimelightHelpers.SetRobotOrientation(getName(), rotationSupplier.get().getDegrees() + 180, 0, 0, 0, 0, 0);
            }
        }
        ...
        if (mt2 != null) {
            if (Math.abs(angularVelocitySupplier.get()) > 720) // if our angular velocity is greater than 720 degrees per
